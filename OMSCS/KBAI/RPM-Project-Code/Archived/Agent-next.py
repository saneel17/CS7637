...
class Agent:
    ...
    basic_answers = {"Basic Problem B-01": 2,
    ...
    def Solve(self, problem):
        '''
        if problem.problemSetName != "Basic Problems D" and problem.problemSetName != "Challenge Problems D" and problem.problemSetName != "Basic Problems D" and problem.problemSetName != "Challenge Problems E":
            return 1
        '''
        ...
        if problem.problemSetName == "Basic Problems D" or problem.problemSetName == "Test Problems D" or problem.problemSetName == "Challenge Problems D" or problem.problemSetName == "Raven's Problems D":
            ...
            dpr_f_a = self.Calculate_DPR(self.image_d, self.image_b)
            ipr_f_a = self.Calculate_IPR(self.image_d, self.image_b)
    ...
    def calculate_bitwise(self, image1, image2):
        ...
        if max_index == 0:
            ...
            '''
            cv2.imshow("bitwise_and_h", compare_to)
            cv2.waitKey(0)
            '''
        else:
